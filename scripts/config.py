...
NUM_ROW = 24
NUM_COLUMN = 24
NUM_EPOCHS = 5000    # number of epochs to train for
FILE_EXTENSION = ".png"
...
SAVED_MODEL_DIR = "../saved_models/resnet50v2"
SAVED_MODEL_NAME = "resnet50v2"
...
LOG_DIR = "../running_logs/resnet50v2"
...
WANDB_PROJECT_NAME = "CNN_bleve_resnet50v2"
